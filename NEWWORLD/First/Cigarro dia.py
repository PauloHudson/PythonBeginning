#5 - Escreva um programa para calcular a redução do tempo de vida de um fumante. 
...
print (f'equivalente a perder cerca de {lifetime} dias de vida ou {anos:.3} anos, ou {meses} meses ')
